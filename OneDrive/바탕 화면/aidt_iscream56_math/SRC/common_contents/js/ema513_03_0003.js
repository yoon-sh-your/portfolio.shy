runAfterAppReady(() => { // 앱 준비 후 실행, jQuery 사용가능 
    ...
    let showAfterSecondError2 = document.querySelector(".ema513_03_su_0003 .page_2 .example_box");
    let showAfterSecondError3 = document.querySelector(".ema513_03_su_0003 .page_3 .example_box");
    // 오답 시 추가 동작
