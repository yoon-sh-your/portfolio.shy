...
runAfterAppReady(() => {
    ...
    const $draggable = $(".page_1 .drag_checkout .draggable");
    const $droppable = $(".page_1 .drag_checkout .droppable");
    ...
    // 드롭 가능한 영역 초기화
    $droppable.droppable({
        accept: ".page_1 .drag_checkout .draggable", // 정확한 셀렉터로 수정
        tolerance: "pointer",
    ...
    window.onIncorrectTwiceCustom = function () {
        const $sourceDraggables = $(".page_1 .drag_checkout .draggable"); // 원본 드래그 요소 선택
    ...
    window.resetCustom = function () {
        ...
        // 드래그 요소 다시 활성화
        const $draggables = $(".page_1 .drag_checkout .draggable");
