function initPopupPagination() {
    const pagenation = {
        wrap: document.querySelector(".pop_reference_wrap"),
        pages: document.querySelectorAll(".pop_reference_wrap section.contents.paging_layout article.popup_page"),
        totalPages: 0,
        currentPage: 1,
        activePage: null,
    };
    ...
    const goalInner = pagenation.wrap.querySelector(".pop_reference_inner");
    ...
    function updatePagination() {
        ...
        const prefix = pagenation.wrap.classList.contains("pop_reference_wrap") ? "popup_page" : "page";
...
function openPop(selector) {
    ...
    if (selector === ".pop_reference_wrap") {
