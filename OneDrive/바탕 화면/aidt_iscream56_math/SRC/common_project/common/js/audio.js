class AudioManager {
    ...
    initAudioElements() {
        ...
        const audioSources = {
            click: "../../common_project/common/audio/0-click.mp3",
            correct: "../../common_project/common/audio/5-drop-o.mp3",
            incorrect: "../../common_project/common/audio/5-drop-x.wav",
            drag: "../../common_project/common/audio/tick.mp3",
            drop: "../../common_project/common/audio/5-drop.mp3",
        };
...
document.body.addEventListener("click", (event) => {
    ...
    const isDrawingGridAreaButton = target.closest(".drawing_grid_area .hit_area");

    if (
        (isButton || isSelectOption || isRadioLabel || isDrawingGridAreaButton) &&
